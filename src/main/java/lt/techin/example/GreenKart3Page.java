...
public class GreenKart3Page extends GreenKartPage{
    ...
    public GreenKart3Page(WebDriver driver) {
        super(driver);
    }
    ...
    public void clickNextPaginationButton(){
        ...
        if(nextPaginationButton.isDisplayed() && nextPaginationButton.isEnabled()) {
            WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(3));
            wait.until(ExpectedConditions.stalenessOf(nextPaginationButton));
    ...
    public void clickLastPaginationButton(){
        ...
        if(lastPaginationButton.isDisplayed() && lastPaginationButton.isEnabled()) {
            WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(3));
            wait.until(ExpectedConditions.stalenessOf(lastPaginationButton));
